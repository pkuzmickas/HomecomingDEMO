...
public:
	...
	static Entity* createSoldier(int posX, int posY, int width, int height, Globals::Layers layer, SDL_Texture* texture, std::string spriteName, SDL_Renderer* renderer, Graphics* graphics, std::string* speakerID = NULL);
